      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        <nav className="navbar bg-base-100/30 backdrop-blur-2xl border border-white/10 rounded-2xl shadow-2xl mb-8 px-6 py-2 relative z-20">
                ...
                <li>
                  <details>
                    ...
                    <ul>
                      ...
                      <li><a onClick={() => navigate("/product-pie")}>Product Analysis</a></li>
                    </ul>
                  </details>
                </li>
                <li>
                  <details>
                    ...
                    <ul>
                      <li><a onClick={() => navigate("/transaction-list/OUT")}>Out Transaction Report</a></li>
                      <li><a onClick={() => navigate("/transaction-list/IN")}>In Transaction Report</a></li>
                      <li><a onClick={() => navigate("/transaction-list/ALL")} className="text-secondary font-bold">Audit Report</a></li>
                    </ul>
                  </details>
                </li>
              </ul>
          ...
          <div className="navbar-center hidden lg:flex">
            <ul className="menu menu-horizontal px-1 gap-12">
              ...
              <li tabIndex={0} className="mx-1">
                <details>
                  <summary className="px-4">Reports</summary>
                  <ul className="p-2 bg-base-100/80 backdrop-blur-md z-[100] w-64">
                    <li><a onClick={() => navigate("/transaction-list/OUT")}>Out Transaction Report</a></li>
                    <li><a onClick={() => navigate("/transaction-list/IN")}>In Transaction Report</a></li>
                    <li><a onClick={() => navigate("/transaction-list/ALL")} className="text-secondary font-bold">Full Audit Report</a></li>
                  </ul>
                </details>
              </li>
            </ul>
        ...
        <div className="hero min-h-[300px] rounded-3xl bg-base-100/30 backdrop-blur-2xl border border-white/10 shadow-2xl p-8 mb-12">
          <div className="hero-content text-center">
            <div>
              <h1 className="text-5xl font-bold">Welcome, <span className="text-primary">Manager</span> 👋</h1>
              <p className="py-6 text-lg opacity-80 max-w-2xl mx-auto">
                Monitor product inventory, track demand, and analyze stock status efficiently using the SmartShelfX smart management system.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="card bg-base-100/20 backdrop-blur-md border border-white/10 shadow-xl hover:shadow-2xl transition-all duration-300 cursor-pointer" onClick={() => navigate("/product-list")}>
            <div className="card-body items-center text-center">
              ...
              <p>Check current stock levels and product details.</p>
            </div>
          </div>
          <div className="card bg-base-100/20 backdrop-blur-md border border-white/10 shadow-xl hover:shadow-2xl transition-all duration-300 cursor-pointer" onClick={() => navigate("/product-pie")}>
            <div className="card-body items-center text-center">
              <div className="w-12 h-12 rounded-full bg-primary/20 flex items-center justify-center text-2xl mb-2">📈</div>
              <h2 className="card-title">Analysis</h2>
              <p>Review product demand and sales trends.</p>
            </div>
          </div>
          <div className="card bg-base-100/20 backdrop-blur-md border border-white/10 shadow-xl hover:shadow-2xl transition-all duration-300 cursor-pointer" onClick={() => navigate("/transaction-list/ALL")}>
            <div className="card-body items-center text-center">
              <div className="w-12 h-12 rounded-full bg-primary/20 flex items-center justify-center text-2xl mb-2">📜</div>
              <h2 className="card-title">Reports</h2>
              <p>Access transaction summaries and insights.</p>
            </div>
          </div>
        </div>
      </div>
